...
public function actionTest($id,$loan,$dtype)
{
	$model = new Document;
	$model->setIsnewRecord(true);
	$model->documentId=null;
	$model->loanId=$loan;
	$model->documentType=$dtype;
	$model->save();
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Document']))
		{
			...
			if($model->save())
            {
				...
				$this->redirect(array('create','id'=>$model->documentId));
            }
		}
	...
	public function actionUpdate($id)
	{
		...
		if(isset($_POST['Document']))
		{
            ...
            {
                Yii::app()->user->setFlash("success","Record saved!");
				$this->redirect(array('admin','id'=>$model->documentId));
            }
		}
