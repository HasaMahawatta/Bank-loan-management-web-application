...
class LoanTypeController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['LoanType']))
		{
			...
			if($model->save())
            {
				...
				$this->redirect(array('create','id'=>$model->loanTypeCode));
            }
		}
	...
	public function actionUpdate($id)
	{
		...
		if(isset($_POST['LoanType']))
		{
            ...
            {
                Yii::app()->user->setFlash("success","Record saved!");
				$this->redirect(array('admin','id'=>$model->loanTypeCode));
            }
		}
	 ...
	 * @param LoanType $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='loan-type-form')
		{
