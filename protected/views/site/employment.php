<section class="bodyContent" style="background-color:#FFF">    
    <div class="columnLeftQ" >
        <?php
        $this->renderPartial('leftBar', array('item' => 2));
        ?>
    </div>
    <div class="columnsCenterQ" style="">
        <div class="page-header">
            <h2 class="colored">Evaluation - Employment Information</h2>
        </div>       
        <div class="questions">
            <?php
            ...
            ?>
            <?php
            echo CHtml::hiddenField('nextAction', 2);
            ?>
            <?php
            $this->renderPartial('_questionPart', array('qcat' => 1));
            ?>
            <?php $this->endWidget(); ?>            
        </div>
        <div class="row">
