...
(function() {
        ...
        for (var c = "{", d = !1, e, f, g, h, i, j = []; (c = a.indexOf(c)) !==
            ...
            if (d) {
                ...
                for (h = 0; h < i; h++)
                    e = e[g[h]];
                if (f.length)
                    f = f.join(":"), g = /\.([0-9])/, h = F.lang, i = void 0, /f$/.test(f) ? (i = (i = f.match(g)) ? i[1] : -1, e !== null && (e = z.numberFormat(e, i, h.decimalPoint, f.indexOf(",") > -1 ? h.thousandsSep : ""))) : e = ka(f, e)
            }
            j.push(e);
            a = a.slice(c + 1);
            c = (d = !d) ? "}" : "{"
    ...
    var r, E = document, T = window, Y = Math, w = Y.round, X = Y.floor, za = Y.ceil, v = Y.max, B = Y.min, R = Y.abs, ba = Y.cos, ga = Y.sin, va = Y.PI, ra = va * 2 / 360, Ha = navigator.userAgent, Rb = T.opera, Ea = /(msie|trident)/i.test(Ha) && !Rb, nb = E.documentMode === 8, Gb = /AppleWebKit/.test(Ha), Va = /Firefox/.test(Ha), fb = /(Mobile|Android|Windows Phone)/.test(Ha), Ia = "http://www.w3.org/2000/svg", ea = !!E.createElementNS && !!E.createElementNS(Ia, "svg").createSVGRect, Wb =
            Va && parseInt(Ha.split("Firefox/")[1], 10) < 4, ma = !ea && !Ea && !!E.createElement("canvas").getContext, Wa, $a, Sb = {}, Hb = 0, lb, F, ka, Ga, Ib, H, ha = function() {
        return r
    }, ca = [], gb = 0, Ua = "div", Z = "none", Xb = /^[0-9]+$/, ob = ["plotTop", "marginRight", "marginBottom", "plotLeft"], Yb = "stroke-width", fa, mb, ub, kb, yb, zb, Ab, cb, db, eb, Ob, Pb, Bb, Cb, Db, I = {}, z;
    ...
    ka = function(a, b, c) {
        if (!s(b) || isNaN(b))
            return"Invalid date";
        var a = p(a, "%Y-%m-%d %H:%M:%S"), d = new fa(b - bb(b)), e, f = d[zb](), g = d[Ab](), h = d[cb](), i = d[db](), j = d[eb](), k = F.lang, l = k.weekdays, d = x({a: l[g].substr(0, 3), A: l[g], d: Ra(h), e: h, w: g, b: k.shortMonths[i], B: k.months[i], m: Ra(i + 1), y: j.toString().substr(2, 2), Y: j, H: Ra(f), I: Ra(f %
                    12 || 12), l: f % 12 || 12, M: Ra(d[yb]()), p: f < 12 ? "AM" : "PM", P: f < 12 ? "am" : "pm", S: Ra(d.getSeconds()), L: Ra(w(b % 1E3), 3)}, z.dateFormats);
        for (e in d)
            for (; a.indexOf("%" + e) !== - 1; )
    ...
    z.numberFormat = function(a, b, c, d) {
        var e = F.lang, a = +a || 0, f = b === -1 ? B((a.toString().split(".")[1] || "").length, 20) : isNaN(b = R(b)) ? 2 : b, b = c ===
                void 0 ? e.decimalPoint : c, d = d === void 0 ? e.thousandsSep : d, e = a < 0 ? "-" : "", c = String(C(a = R(a).toFixed(f))), g = c.length > 3 ? c.length % 3 : 0;
        ...
        T.HighchartsAdapter = T.HighchartsAdapter || a && {init: function(b) {
                ...
                a.each(["cur", "_default", "width", "height", "opacity"], function(b, e) {
                    ...
                    (g = f[e]) && (f[e] = function(a) {
                        var c, a = b ? a : this;
                        if (a.prop !== "align")
                            return c = a.elem, c.attr ? c.attr(a.prop, e === "cur" ? r : a.now) : g.apply(this, arguments)
                    })
                });
                ...
                a.fn.highcharts = function() {
                    ...
                    if (this[0]) {
                        ...
                        c === r && (g = ca[W(this[0], "data-highcharts-chart")])
                    }
                    return g
                }
    ...
    Q && Q.init.call(Q, Ib);
    var pb = G.adapterRun, Zb = G.getScript, Oa = G.inArray, n = z.each = G.each, hb = G.grep, $b = G.offset, Aa = G.map, D = G.addEvent, U = G.removeEvent, K = G.fireEvent, ac = G.washMouseEvent, qb = G.animate, ab =
            G.stop;
    F = {colors: "#7cb5ec,#434348,#90ed7d,#f7a35c,#8085e9,#f15c80,#e4d354,#2b908f,#f45b5b,#91e8e1".split(","), symbols: ["circle", "diamond", "square", "triangle", "triangle-down"], lang: {loading: "Loading...", months: "January,February,March,April,May,June,July,August,September,October,November,December".split(","), shortMonths: "Jan,Feb,Mar,Apr,May,Jun,Jul,Aug,Sep,Oct,Nov,Dec".split(","), weekdays: "Sunday,Monday,Tuesday,Wednesday,Thursday,Friday,Saturday".split(","), decimalPoint: ".", numericSymbols: "k,M,G,T,P,E".split(","),
        ...
        tooltip: {enabled: !0, animation: ea, backgroundColor: "rgba(249, 249, 249, .85)", borderWidth: 1, borderRadius: 3, dateTimeLabelFormats: {millisecond: "%A, %b %e, %H:%M:%S.%L", second: "%A, %b %e, %H:%M:%S", minute: "%A, %b %e, %H:%M", hour: "%A, %b %e, %H:%M", day: "%A, %b %e, %Y", week: "Week from %A, %b %e, %Y", month: "%B %Y", year: "%Y"}, footerFormat: "", headerFormat: '<span style="font-size: 10px">{point.key}</span><br/>', pointFormat: '<span style="color:{point.color}">●</span> {series.name}: <b>{point.y}</b><br/>', shadow: !0,
            snap: fb ? 25 : 10, style: {color: "#333333", cursor: "default", fontSize: "12px", padding: "8px", whiteSpace: "nowrap"}}, credits: {enabled: !0, text: "", href: "http://www.highcharts.com", position: {align: "right", x: -10, verticalAlign: "bottom", y: -5}, style: {cursor: "pointer", color: "#909090", fontSize: "9px"}}};
    ...
    $.prototype = {opacity: 1, textProps: "fontSize,fontWeight,fontFamily,color,lineHeight,width,textDecoration,textShadow".split(","), init: function(a, b) {
            this.element = b === "span" ? aa(b) : E.createElementNS(Ia, b);
            this.renderer = a
            ...
            if (f) {
                ...
                f === "radialGradient" && m && !s(g.gradientUnits) && (g = y(g, {cx: m[0] - m[2] / 2 + g.cx * m[2], cy: m[1] - m[2] / 2 + g.cy * m[2], r: g.r * m[2], gradientUnits: "userSpaceOnUse"}));
                for (o in g)
                    o !== "id" && q.push(o,
                            g[o]);
                for (o in j)
            ...
            var b = this.element, c, d = a.indexOf("contrast") !== -1, e = this.renderer.forExport || b.style.textShadow !==
                    r && !Ea;
            ...
            e ? d && M(b, {textShadow: a}) : (this.fakeTS = !0, this.ySetter = this.xSetter, c = [].slice.call(b.getElementsByTagName("tspan")), n(a.split(/\s?,\s?/g), function(a) {
                ...
                (i = a[a.length - 2]) && n(c, function(a, c) {
                    ...
                    f = a.cloneNode(1);
                    W(f, {"class": "highcharts-text-shadow",
                        fill: e, stroke: e, "stroke-opacity": 1 / v(C(i), 3), "stroke-width": i, "stroke-linejoin": "round"});
                    b.insertBefore(f, d)
                })
            }))
        }, attr: function(a, b) {
            ...
            if (!b) {
                if (f.namespaceURI === Ia || c.forExport) {
                    try {
                        k =
                                ...
                                }, Va && j.textShadow ? (i = j.textShadow, j.textShadow = "") : k && k(Z), b = f.getBBox ? x({}, f.getBBox()) : {width: f.offsetWidth, height: f.offsetHeight}, i ? j.textShadow = i : k && k("")
                    } catch (m) {
                    }
                    if (!b || b.width < 0)
                        b = {width: 0, height: 0}
                ...
                if (c.isSVG) {
                    a = b.width;
                    d = b.height;
                    if (Ea && g && g.fontSize === "11px" && d.toPrecision(3) === "16.9")
                        b.height = d = 14;
                    if (e)
                        b.width = R(d * ga(h)) + R(a * ba(h)), b.height = R(d * ba(h)) + R(a *
                                ga(h))
                }
                c.cache[l] = b
            }
            ...
            if (a) {
                ...
                for (e = 1; e <= i; e++) {
                    ...
                    if (c)
                        W(f, "height", v(W(f, "height") - h, 0)), f.cutHeight = h;
            ...
            b || (b = E.createElementNS(Ia, "title"), this.element.appendChild(b));
            ...
            if (e) {
                ...
                for (i = 0; i < d.length && !h; i++)
                    if (e = d[i], f = W(e, "zIndex"), e !== g && (C(f) > a || !s(a) && s(f)))
    ...
    $.prototype["stroke-widthSetter"] = $.prototype.strokeSetter = function(a, b, c) {
        ...
        if (this.stroke && this["stroke-width"])
            this.strokeWidth = this["stroke-width"], $.prototype.fillSetter.call(this, this.stroke, "stroke", c), c.setAttribute("stroke-width",
    ...
    na.prototype = {Element: $, init: function(a, b, c, d, e) {
            var f = location, g, d = this.createElement("svg").attr({version: "1.1"}).css(this.getStyle(d));
            g = d.element;
            a.appendChild(g);
            a.innerHTML.indexOf("xmlns") === -1 && W(g, "xmlns", Ia);
            this.isSVG = !0;
            this.box = g;
            this.boxWrapper = d;
            this.alignedObjects = [];
            ...
            this.createElement("desc").add().element.appendChild(E.createTextNode("Created with Highstock 2.1.4"));
        ...
        buildText: function(a) {
            ...
            !f && !o && !q && e.indexOf(" ") === -1 ? b.appendChild(E.createTextNode(u(e))) : (h = /<.*style="([^"]+)".*>/, i = /<.*href="(http[^"]+)".*>/, J && J.appendChild(b), e = f ? e.replace(/<(b|strong)>/g, '<span style="font-weight:bold">').replace(/<(i|em)>/g, '<span style="font-style:italic">').replace(/<a/g, "<span").replace(/<\/(b|strong|i|em|a)>/g, "</span>").split(/<br.*?>/g) : [e], e[e.length - 1] === "" && e.pop(), n(e, function(e, f) {
                ...
                n(g, function(e) {
                    if (e !==
                            "" || g.length === 1) {
                        var o = {}, t = E.createElementNS(Ia, "tspan"), J;
                        ...
                        if (e !== " ") {
                            ...
                            W(t, o);
                            b.appendChild(t);
                            !m && f && (!ea && d && M(t, {display: "block"}), W(t, "dy", N(t)));
                            if (l) {
                                for (var o = e.replace(/([^\^])-/g, "$1- ").split(" "), n = g.length >
                                        1 || f || o.length > 1 && k.whiteSpace !== "nowrap", p, A, r, s = [], w = N(t), v = 1, x = a.rotation, y = e, B = y.length; (n || q) && (o.length || s.length); )
                                    a.rotation = 0, p = a.getBBox(!0), r = p.width, !ea && c.forExport && (r = c.measureSpanWidth(t.firstChild.data, a.styles)), p = r > l, A === void 0 && (A = p), q && A ? (B /= 2, y === "" || !p && B < 0.5 ? o = [] : (p && (A = !0), y = e.substring(0, y.length + (p ? -1 : 1) * za(B)), o = [y + "…"], t.removeChild(t.firstChild))) : !p || o.length === 1 ? (o = s, s = [], o.length && (v++, t = E.createElementNS(Ia, "tspan"), W(t, {dy: w, x: j}), J && W(t, "style", J), b.appendChild(t)),
            ...
            var j = this.label(a, b, c, i, null, null, null, null, "button"), k = 0, l, m, o, q, t, J, a = {x1: 0, y1: 0, x2: 0, y2: 1}, e = y({"stroke-width": 1, stroke: "#CCCCCC", fill: {linearGradient: a,
                    stops: [[0, "#FEFEFE"], [1, "#F6F6F6"]]}, r: 2, padding: 5, style: {color: "black"}}, e);
            o = e.style;
            delete e.style;
            ...
            J = h.style;
            delete h.style;
            D(j.element, Ea ? "mouseover" : "mouseenter", function() {
                k !== 3 && j.attr(f).css(q)
            });
            D(j.element, Ea ? "mouseout" : "mouseleave", function() {
                k !== 3 &&
            ...
            var e = ia(a) ? a.r : e, g = this.createElement("rect"), a = ia(a) ? a : a === r ? {} : {x: a, y: b, width: v(c, 0), height: v(d, 0)};
            if (f !== r)
            ...
            if (h)
                g = this.path(h), x(g, {symbolName: a, x: b, y: c, width: d, height: e}), f && x(g, f);
            else if (i.test(a))
                k = function(a, b) {
                    a.element && (a.attr({width: b[0], height: b[1]}), a.alignByTranslate || a.translate(w((d - b[0]) / 2), w((e - b[1]) / 2)))
                }, j = a.match(i)[1], a = Sb[j] || f && f.width && f.height && [f.width, f.height], g = this.image(j).attr({x: b, y: c}), g.isImg = !0, a ? k(g, a) : (g.attr({width: 0,
                    height: 0}), aa("img", {onload: function() {
            ...
            function j() {
                ...
                if (E) {
                    if (!t)
                        a = w(-p * u), b = h ? -D : 0, o.box = t = d ? m.symbol(d, a, b, o.width, o.height, L) : m.rect(a, b, o.width, o.height, 0, L[Yb]), t.attr("fill", Z).add(o);
            ...
            function k() {
                ...
                if (b !== q.x || c !== q.y)
                    q.attr("x", b), c !== r && q.attr(q.element.nodeName === "SPAN" ? "y" : "translateY", c);
                q.x = b;
                q.y = c
            }
            function l(a, b) {
            ...
            var m = this, o = m.g(i), q = m.text("", 0, 0, g).attr({zIndex: 1}), t, J, p = 0, u = 3, A = 0, oa, v, B, Jb, z = 0, L = {}, D, E;
            o.onAdd = function() {
                q.add(o);
            ...
            return x(o, {css: function(a) {
                    ...
                    return{width: J.width + 2 * u, height: J.height + 2 * u, x: J.x - u, y: J.y - u}
                }, shadow: function(a) {
                    t && t.shadow(a);
                    return o
                }, destroy: function() {
    ...
    Wa = na;
    x($.prototype, {htmlCss: function(a) {
            var b = this.element;
                ...
                if (b.tagName === "SPAN") {
                    ...
                    if (o !== this.cTT) {
                        ...
                        if (i > m && /[ \-]/.test(b.textContent || b.innerText))
                            M(b, {width: m + "px", display: "block", whiteSpace: j && j.whiteSpace || "normal"}), i = m;
            ...
            var d = {}, e = Ea ? "-ms-transform" : Gb ? "-webkit-transform" : Va ? "MozTransform" : Rb ? "-o-transform" : "";
                    ...
                    if (this.parentGroup = a) {
                        if (b = a.div, !b) {
                            ...
                            n(j.reverse(), function(a) {
                                var d;
                                b = a.div = a.div || aa(Ua, {className: W(a.element, "class")}, {position: "absolute", left: (a.translateX || 0) + "px", top: (a.translateY || 0) + "px"}, b || c);
                                d = b.style;
    ...
    if (!ea && !ma)
        G =
                {init: function(a, b) {
                        ...
                        c.style[b] = a
                    }}, z.VMLElement = G = ja($, G), G.prototype.ySetter = G.prototype.widthSetter = G.prototype.heightSetter = G.prototype.xSetter, G = {Element: G, isIE8: Ha.indexOf("MSIE 8.0") > -1, init: function(a, b, c, d) {
                var e;
                this.alignedObjects = [];
                ...
                return x(e, {members: [],
                    count: 0, left: (f ? a.x : a) + 1, top: (f ? a.y : b) + 1, width: (f ? a.width : c) - 1, height: (f ? a.height : d) - 1, getCSS: function(a) {
                ...
                if (i) {
                    var k, l, m = a.linearGradient || a.radialGradient, o, q, t, J, p, u = "", a = a.stops, A, oa = [], r = function() {
                    ...
                    if (c === "fill")
                        if (i === "gradient")
                            c = m.x1 || m[0] || 0, a = m.y1 || m[1] || 0, o = m.x2 || m[2] || 0, m = m.y2 || m[3] || 0, u = 'angle="' + (90 - Y.atan((m - a) / (o - c)) * 180 / va) + '"', r();
                        else {
                ...
                M(a, {flip: "x", left: C(d.width) - (e ? C(e.top) : 1), top: C(d.height) - (e ? C(e.left) : 1), rotation: -90});
    ...
    Za.prototype = {addLabel: function() {
            ...
            this.isFirst = i;
            this.isLast = j;
            b = a.labelFormatter.call({axis: a, chart: c, isFirst: i, isLast: j, dateTimeLabelFormat: k, value: a.isLog ? la(ta(e)) : e});
        ...
        getLabelSize: function() {
            ...
            if (h)
                h < 0 && c - i * j < f ? k = w(c / ba(h * ra) - f) : h > 0 && c + i * j > e && (k = w((d - c) / ba(h * ra)));
            else {
                d = c - i * j;
                c += i * j;
                if (d < f)
                    b -= f - d, a.x = f, g.attr({align: "left"});
                else if (c > e)
                    b -= c - e, a.x =
            ...
            var i = this.axis, j = i.transA, k = i.reversed, l = i.staggerLines, m = i.tickRotCorr ||
                    {x: 0, y: 0}, c = p(e.y, m.y + (i.side === 2 ? 8 : -(c.getBBox().height / 2))), a = a + e.x + m.x - (f && d ? f * j * (k ? -1 : 1) : 0), b = b + c - (f && !d ? f * j * (k ? 1 : -1) : 0);
            l && (b += g / (h || 1) % l * (i.labelOffset / l));
            return{x: a, y: w(b)}
        }, getMarkPath: function(a, b, c, d, e, f) {
            return f.crispLine(["M", a, b, "L", a + (e ? 0 : -c), b + (e ? c : 0)], d)
        }, render: function(a, b, c) {
            var d = this.axis, e = d.options, f = d.chart.renderer, g = d.horiz, h = this.type, i = this.label, j = this.pos, k = e.labels, l = this.gridLine, m = h ? h + "Grid" : "grid", o = h ? h + "Tick" : "tick", q = e[m + "LineWidth"], t = e[m + "LineColor"], J = e[m +
                    "LineDashStyle"], n = e[o + "Length"], m = e[o + "Width"] || 0, u = e[o + "Color"], A = e[o + "Position"], o = this.mark, oa = k.step, s = !0, w = d.tickmarkOffset, v = this.getPosition(g, j, w, b), x = v.x, v = v.y, y = g && x === d.pos + d.len || !g && v === d.pos ? -1 : 1, c = p(c, 1);
            this.isActive = !0;
            if (q) {
            ...
            if (m && n)
                A === "inside" &&
                        (n = -n), d.opposite && (n = -n), h = this.getMarkPath(x, v, n, m * y, g, f), o ? o.animate({d: h, opacity: c}) : this.mark = f.path(h).attr({stroke: u, "stroke-width": m, opacity: c}).add(d.axisGroup);
            if (i && !isNaN(x))
                i.xy = v = this.getLabelPosition(x, v, i, g, k, w, a, oa), this.isFirst && !this.isLast && !p(e.showFirstLabel, 1) || this.isLast && !this.isFirst && !p(e.showLastLabel, 1) ? s = !1 : g && !d.isRadial && !k.step && !k.rotation && !b && c !== 0 && this.handleOverflow(v), oa && a % oa && (s = !1), s && !isNaN(v.y) ? (v.opacity = c, i[this.isNew ? "attr" : "animate"](v), this.isNew =
                        !1) : i.attr("y", -9999)
        }, destroy: function() {
            Na(this, this.axis)
        }};
    ...
    z.PlotLineOrBand.prototype = {render: function() {
            ...
            if (g) {
                if (o = b.getPlotLinePath(k, g), u = {stroke: t, "stroke-width": g}, l)
                    u.dashstyle = l
            } else if (j) {
                o =
            ...
            else if (o && o.length && (a.svgElem = m = A.path(o).attr(u).add(), n))
            ...
            if (e && s(e.text) && o && o.length && b.width > 0 && b.height > 0) {
                e = y({align: c && j && "center", x: c ? !j && 4 : 10, verticalAlign: !c &&
                            j && "middle", y: c ? j ? 16 : 10 : j ? 6 : -4, rotation: c && !j && 90}, e);
                if (!f) {
    ...
    O.prototype =
            {defaultOptions: {dateTimeLabelFormats: {millisecond: "%H:%M:%S.%L", second: "%H:%M:%S", minute: "%H:%M", hour: "%H:%M", day: "%e. %b", week: "%e. %b", month: "%b '%y", year: "%Y"}, endOnTick: !1, gridLineColor: "#D8D8D8", labels: {enabled: !0, style: {color: "#606060", cursor: "default", fontSize: "11px"}, x: 0, y: 15}, lineColor: "#C0D0E0", lineWidth: 1, minPadding: 0.01, maxPadding: 0.01, minorGridLineColor: "#E0E0E0", minorGridLineWidth: 1, minorTickColor: "#A0A0A0", minorTickLength: 2, minorTickPosition: "outside", startOfWeek: 1, startOnTick: !1,
                    ...
                    for (f in d)
                        D(this, f, d[f]);
                    if (this.isLog)
                        this.val2lin = La, this.lin2val = ta
                    ...
                    if (h)
                        ...
                        for (; f-- && g === r; )
                            c = Math.pow(1E3, f + 1), a >= c && e[f] !== null && (g = z.numberFormat(b / c, -1) + e[f]);
                        ...
                        if (c.visible || !b.options.chart.ignoreHiddenSeries) {
                            ...
                            if (a.isXAxis) {
                                if (d = c.xData, d.length)
                                    a.dataMin = B(p(a.dataMin, d[0]), Sa(d)), a.dataMax = v(p(a.dataMax, d[0]), Fa(d))
                            } else {
                                c.getExtremes();
                                e = c.dataMax;
                                c = c.dataMin;
                                if (s(c) && s(e))
                                    a.dataMin = B(p(a.dataMin, c), c), a.dataMax = v(p(a.dataMax, e), e);
                                if (s(d))
                                    if (a.dataMin >= d)
                    ...
                    return m && !d ? null : f.renderer.crispLine(["M", a, i, "L", c, j], b || 1)
                        ...
                        b, c) {
                    var d, e = la(X(b / a) * a), f = la(za(c / a) * a), g = [];
                    if (b === c && sa(b))
                        return[b];
                    for (b = e; b <= f; ) {
                        g.push(b);
                    ...
                    if (k || i || d)
                        if (h ? (f = h.minPointOffset, g = h.pointRangePadding) : n(b.series, function(a) {
                            ...
                            !a.noSharedTooltip && s(q) && (e = s(e) ? B(e, q) : q)
                        }), h = b.ordinalSlope && e ? b.ordinalSlope / e : 1, b.minPointOffset = f *= h, b.pointRangePadding = g *= h, b.pointRange = B(d, c), k)
                    ...
                    if (e)
                        !a && B(b.min, p(b.dataMin, b.min)) <= 0 && qa(10, 1), b.min = la(La(b.min)), b.max = la(La(b.max));
                    if (b.range && s(b.max))
                    ...
                    var a = this.isLog;
                    return{min: a ? la(ta(this.min)) : this.min, max: a ? la(ta(this.max)) : this.max, dataMin: this.dataMin,
                    ...
                    c ? (l = s(h) ? [h] : f < 80 && !b.staggerLines && !b.step && b.autoRotation) && n(l, function(a) {
                        var b;
                        if (a === h || a && a >= -90 && a <= 90)
                            j = m(R(i.h / ga(ra * a))), b = j + R(a / 360), b < k && (k = b, g = a, e = j)
                    }) : e = m(i.h);
                    this.autoRotation = l;
                    ...
                    var a = this.chart, b = a.renderer, c = this.tickPositions, d = this.ticks, e = this.options.labels, f = this.horiz, g = a.margin,
                            h = this.slotWidth = f && !e.step && !e.rotation && (this.staggerLines || 1) * a.plotWidth / c.length || !f && (g[3] && g[3] - a.spacing[3] || a.chartWidth * 0.33), i = v(1, w(h - 2 * (e.padding || 5))), j = {}, g = b.fontMetrics(e.style.fontSize, d[0] && d[0].label), k, l = 0;
                    if (!Ja(e.rotation))
                    ...
                    if (this.autoRotation)
                        ...
                        for (h = c.length; !f && h--; )
                            if (i = c[h], (i = d[i].label) &&
                                    this.len / c.length - 4 < i.getBBox().height)
                    ...
                    n(c, function(a) {
                        var b = (a = d[a]) && a.label;
                        if (b)
                            k && b.css(y(k, b.specCss)), delete b.specCss, b.attr(j), a.rotation = j.rotation
                    });
                    this.tickRotCorr = b.rotCorr(g.b, this.labelRotation || 0, this.side === 2)
                }, getOffset: function() {
                    var a = this, b = a.chart, c = b.renderer,
                            d = a.options, e = a.tickPositions, f = a.ticks, g = a.horiz, h = a.side, i = b.inverted ? [1, 0, 3, 2][h] : h, j, k, l = 0, m, o = 0, q = d.title, t = d.labels, J = 0, N = b.axisOffset, b = b.clipOffset, u = [-1, 1, 1, -1][h], A;
                    a.hasData = j = a.hasVisibleSeries || s(a.min) && s(a.max) && !!e;
                    a.showAxis = k = j || p(d.showEmpty, !0);
                    a.staggerLines = a.horiz && t.staggerLines;
                    if (!a.axisGroup)
                        a.gridGroup = c.g("grid").attr({zIndex: d.gridZIndex || 1}).add(), a.axisGroup = c.g("axis").attr({zIndex: d.zIndex || 2}).add(), a.labelGroup = c.g("axis-labels").attr({zIndex: t.zIndex || 7}).addClass("highcharts-" +
                    ...
                    if (q && q.text && q.enabled !== !1) {
                        ...
                        if (k)
                            l = a.axisTitle.getBBox()[g ? "height" : "width"], m = q.offset, o = s(m) ? 0 : p(q.margin, g ? 5 : 10);
                    ...
                    if (t || f) {
                        ...
                        if (g.length && (n(g, function(b, c) {
                            if (!f || b >= a.min && b <= a.max)
                                i[b] || (i[b] = new Za(a, b)), p && i[b].isNew && i[b].render(c, !0, 0.1), i[b].render(c)
                        }), o && (a.min === 0 || a.single)))
                            i[-1] || (i[-1] = new Za(a, -1, null, !0)), i[-1].render(-1);
                        m && n(g, function(b, c) {
                            if (c % 2 === 0 && b < a.max)
                                k[b] || (k[b] = new z.PlotLineOrBand(a)), u = b + o, A = g[c + 1] !== r ? g[c +
                                1] + o : a.max, k[b].options = {from: e ? ta(u) : u, to: e ? ta(A) : A, color: m}, k[b].render(), k[b].isActive = !0
                        });
                        if (!a._addedPlotLB)
                    ...
                    if (q)
                        t =
                                a.getLinePath(q), a.axisLine ? a.axisLine.animate({d: t}) : a.axisLine = c.path(t).attr({stroke: d.lineColor, "stroke-width": q, zIndex: 7}).add(a.axisGroup), a.axisLine[N ? "show" : "hide"]();
                    if (h && N)
                    ...
                    if (!this.crosshair || (s(b) || !p(this.crosshair.snap, !0)) === !1)
                        this.hideCrosshair();
                    else if (p(d.snap, !0) ? s(b) && (c = this.isXAxis ? b.plotX : this.len - b.plotY) : c = this.horiz ? a.chartX -
                            this.pos : this.len - a.chartY + this.pos, c = this.isRadial ? this.getPlotLinePath(this.isXAxis ? b.x : p(b.stackY, b.y)) || null : this.getPlotLinePath(null, null, null, null, c) || null, c === null)
                        this.hideCrosshair();
                    else if (this.cross)
    ...
    x(O.prototype, {getPlotBandPath: function(a, b) {
            ...
            c &&
                    (b && (d[b] = d[b] || [], d[b].push(a)), this.plotLinesAndBands.push(c));
            return c
    ...
    O.prototype.getTimeTicks = function(a, b, c, d) {
        var e = [], f = {}, g = F.global.useUTC, h, i = new fa(b - bb(b)), j = a.unitRange, k = a.count;
        if (s(b)) {
            i.setMilliseconds(j >= H.second ?
                    0 : k * X(i.getMilliseconds() / k));
            j >= H.second && i.setSeconds(j >= H.minute ? 0 : k * X(i.getSeconds() / k));
            if (j >= H.minute)
                i[Ob](j >= H.hour ? 0 : k * X(i[yb]() / k));
            if (j >= H.hour)
                i[Pb](j >= H.day ? 0 : k * X(i[zb]() / k));
            if (j >= H.day)
                i[Bb](j >= H.month ? 1 : k * X(i[cb]() / k));
            j >= H.month && (i[Cb](j >= H.year ? 0 : k * X(i[db]() / k)), h = i[eb]());
            j >= H.year && (h -= h % k, i[Db](h));
            if (j === H.week)
                i[Bb](i[cb]() - i[Ab]() + p(d, 1));
            b = 1;
            if (ub || kb)
                i = i.getTime(), i = new fa(i + bb(i));
            h = i[eb]();
            for (var d = i.getTime(), l = i[db](), m = i[cb](), o = (H.day + (g ? bb(i) : i.getTimezoneOffset() *
                    6E4)) % H.day; d < c; )
                e.push(d), j === H.year ? d = mb(h + b * k, 0) : j === H.month ? d = mb(h, l + b * k) : !g && (j === H.day || j === H.week) ? d = mb(h, l, m + b * k * (j === H.day ? 1 : 7)) : d += j * k, b++;
            e.push(d);
            n(hb(e, function(a) {
    ...
    O.prototype.getLogTickPositions = function(a, b, c, d) {
        ...
        if (a >= 0.5)
            ...
            for (var f = X(b), h,
                ...
                i = e.length;
                for (h = 0; h < i && !l; h++)
                    j = La(ta(f) * e[h]), j > b && (!d || k <= c) && k !== r && g.push(k), k > c && (l = !0), k = j
            }
        else if (b = ta(b), c = ta(c), a = e[d ? "minorTickInterval" : "tickInterval"], a = p(a === "auto" ? null : a, this._minorAutoInterval, (c - b) * (e.tickPixelInterval / (d ? 5 : 1)) / ((d ? f / this.tickPositions.length : f) || 1)), a = wb(a, null, vb(a)), g = Aa(this.getLinearTickPositions(a, b, c), La), !d)
    ...
    Kb.prototype = {init: function(a, b) {
            ...
            x(f, {x: g ? (2 * f.x + a) / 3 : a, y: g ? (f.y + b) / 2 : b, anchorX: h ? r : g ? (2 * f.anchorX + c) / 3 : c, anchorY: h ? r : g ? (f.anchorY + d) / 2 : d});
            e.label.attr(f);
            if (g)
            ...
            i === !1 ? this.hide() : (this.isHidden && (ab(d), d.attr("opacity", 1).show()), d.attr({text: i}), k = e.borderColor || a.color || h.color || "#606060", d.attr({stroke: k}), this.updatePosition({plotX: f, plotY: g, negative: a.negative, ttBelow: a.ttBelow}), this.isHidden = !1);
    ...
    Xa.prototype = {init: function(a, b) {
            ...
            if (z.Tooltip && b.tooltip.enabled)
                a.tooltip = new Kb(a, b.tooltip), this.followTouchMove =
                        p(b.tooltip.followTouchMove, !0);
            this.setDOMEvents()
        }, normalize: function(a, b) {
            var c, d, a = a || window.event, a = ac(a);
            if (!a.target)
                a.target = a.srcElement;
            d = a.touches ? a.touches.length ? a.touches.item(0) : a.changedTouches[0] : a;
            if (!b)
                this.chartPosition = b = $b(this.chart.container);
            ...
            var b = this.chart, c = b.series, d = b.tooltip, e = d ? d.shared : !1, f, g = b.hoverPoint, h = b.hoverSeries, i = b.chartWidth, j = b.chartWidth, k, l = [], m, o;
            if (!e && !h)
                for (f = 0; f < c.length; f++)
                    if (c[f].directTouch || !c[f].options.stickyTracking)
                        c = [];
            (!h || !h.noSharedTooltip) && (e || !h) ? (n(c, function(b) {
                k = b.noSharedTooltip && e;
                b.visible && !k && p(b.options.enableMouseTracking, !0) && (o = b.searchPoint(a)) && l.push(o)
            }), n(l, function(a) {
                if (a && s(a.plotX) && s(a.plotY) &&
                        (a.dist.distX < i || (a.dist.distX === i || a.series.kdDimensions > 1) && a.dist.distR < j))
                    i = a.dist.distX, j = a.dist.distR, m = a
            })) : m = h.directTouch && g || h && h.searchPoint(a);
            if (m && (m !== g || d && d.isHidden)) {
                if (e && !m.series.noSharedTooltip) {
                    f = l.length;
                    for (c = m.clientX; f--; )
                        h = l[f].clientX, (l[f].x !== m.x || h !== c || l[f].series.noSharedTooltip) && l.splice(f, 1);
            ...
            if (a)
                ...
                if (this._onDocumentMouseMove)
                    U(E, "mousemove", this._onDocumentMouseMove), this._onDocumentMouseMove = null;
                n(c.axes, function(a) {
                    a.hideCrosshair()
                });
                this.hoverX = null
            ...
            if (this.hasDragged > 10) {
                ...
                this.selectionMarker && g && (d = e - o, this.selectionMarker.attr({height: R(d), y: (d > 0 ? 0 : d) + o}));
                l &&
                    ...
                    n(c.axes, function(c) {
                        if (c.zoomEnabled && s(c.min) && (d || b[{xAxis: "zoomX", yAxis: "zoomY"}[c.coll]])) {
                            var f = c.horiz, o = a.type === "touchend" ? c.minPixelPadding :
                                    0, q = c.toValue((f ? g : h) + o), f = c.toValue((f ? g + i : h + j) - o);
            ...
            a.originalEvent = a;
            a.cancelBubble = !0;
            b.cancelClick || (c && this.inClass(a.target, "highcharts-tracker") ? (K(c.series, "click", x(a, {point: c})), b.hoverPoint && c.firePointEvent("click", a)) : (x(a, this.getCoordinates(a)), b.isInsidePlot(a.chartX - d, a.chartY - e) && K(b, "click", a)))
            ...
            gb === 1 && D(E, "mouseup", a.onDocumentMouseUp);
            if ($a)
                b.ontouchstart = function(b) {
                    a.onContainerTouchStart(b)
                }, b.ontouchmove = function(b) {
                    a.onContainerTouchMove(b)
                }, gb === 1 && D(E, "touchend", a.onDocumentTouchEnd)
        }, destroy: function() {
            var a;
    ...
    if (T.PointerEvent || T.MSPointerEvent) {
        var Ba = {}, Lb = !!T.PointerEvent, ec = function() {
            var a, b = [];
            b.item = function(a) {
                return this[a]
            };
            for (a in Ba)
                Ba.hasOwnProperty(a) && b.push({pageX: Ba[a].pageX, pageY: Ba[a].pageY, target: Ba[a].target});
            return b
        }, Mb = function(a, b, c, d) {
            a = a.originalEvent || a;
            if ((a.pointerType === "touch" || a.pointerType === a.MSPOINTER_TYPE_TOUCH) && ca[xa])
                d(a), d = ca[xa].pointer, d[b]({type: c, target: a.currentTarget,
                    preventDefault: ha, touches: ec()})
        };
        x(Xa.prototype, {onContainerPointerDown: function(a) {
                ...
                Mb(a, "onContainerTouchMove", "touchmove", function(a) {
                    ...
                    if (!Ba[a.pointerId].target)
                        Ba[a.pointerId].target = a.currentTarget
                })
    ...
    rb.prototype = {init: function(a, b) {
            ...
            this.options = b;
            if (b.enabled)
                c.itemStyle = d, c.itemHiddenStyle = y(d, b.itemHiddenStyle), c.itemMarginTop = e, c.padding = d = p(b.padding, 8), c.initialItemX = d, c.initialItemY = d - 5, c.maxItemWidth = 0, c.chart = a, c.itemHeight = 0, c.symbolWidth = p(b.symbolWidth, 16), c.pages = [], c.render(), D(c.chart, "endResize",
                        function() {
            ...
            var b = this.chart, c = b.renderer, d = this.options, e = d.layout === "horizontal", f = this.symbolWidth, g = d.symbolPadding, h = this.itemStyle, i = this.itemHiddenStyle, j = this.padding, k = e ? p(d.itemDistance, 20) : 0, l = !d.rtl, m = d.width, o = d.itemMarginBottom || 0, q = this.itemMarginTop, t = this.initialItemX, n = a.legendItem, N = a.series && a.series.drawLegendSymbol ? a.series : a, u = N.options, u = this.createCheckboxForItem && u && u.showCheckbox, A = d.useHTML;
            if (!n) {
                a.legendGroup =
                        c.g("legend-item").attr({zIndex: 1}).add(this.scrollGroup);
                a.legendItem = n = c.text(d.labelFormat ? Ma(d.labelFormat, a) : d.labelFormatter.call(a), l ? f + g : -g, this.baseline || 0, A).css(y(a.visible ? h : i)).attr({align: l ? "left" : "right", zIndex: 2}).add(a.legendGroup);
                if (!this.baseline)
                    this.baseline = c.fontMetrics(h.fontSize, n).f + 3 + q, n.attr("y", this.baseline);
            ...
            this.display && !d.floating && n([/(lth|ct|rth)/, /(rtv|rm|rbv)/, /(rbh|cb|lbh)/, /(lbv|lm|ltv)/], function(f, g) {
                f.test(e) && !s(a[g]) && (c[ob[g]] = v(c[ob[g]], c.legend[(g + 1) % 2 ? "legendHeight" : "legendWidth"] + [1, -1, -1, 1][g] * d[g % 2 ? "x" : "y"] + p(d.margin,
                        12) + b[g]))
            })
        }, render: function() {
            ...
            if (l || m) {
                if (i) {
                    ...
                    a.box = i = c.rect(0, 0, g, h, j.borderRadius, l || 0).attr({stroke: j.borderColor, "stroke-width": l || 0, fill: m || Z}).add(d).shadow(j.shadow), i.isNew = !0;
                i[f ? "show" : "hide"]()
            }
            a.legendWidth = g;
            a.legendHeight =
            ...
            var b = this, c = this.chart, d = c.renderer, e = this.options, f = e.y, f = c.spacingBox.height + (e.verticalAlign === "top" ? -f : f) - this.padding, g = e.maxHeight, h, i = this.clipRect, j = e.navigation, k = p(j.animation, !0), l = j.arrowSize || 12, m = this.nav, o = this.pages, q, t = this.allItems;
            ...
            e > d && (e = d);
            if (e > 0)
                b !== r && Ya(b, this.chart), this.nav.attr({translateX: j,
                    translateY: f + this.padding + 7 + this.titleHeight, visibility: "visible"}), this.up.attr({fill: e === 1 ? g : h}).css({cursor: e === 1 ? "default" : "pointer"}), i.attr({text: e + "/" + d}), this.down.attr({x: 18 + this.pager.getBBox().width, fill: e === d ? g : h}).css({cursor: e === d ? "default" : "pointer"}), c = -c[e - 1] + this.initialItemY, this.scrollGroup.animate({translateY: c}), this.currentPage = e, this.positionCheckboxes(c)
        }};
    G = z.LegendSymbolMixin = {drawRectangle: function(a, b) {
    ...
    (/Trident\/7\.0/.test(Ha) || Va) && S(rb.prototype, "positionItem", function(a, b) {
    ...
    Pa.prototype = {callbacks: [], init: function(a, b) {
            var c, d = a.series;
            a.series = null;
            c = y(F, a);
            c.series = a.series = d;
        ...
        isInsidePlot: function(a, b, c) {
            ...
            if (c && (c.css({width: (f.width || h) + "px"}).align(x({y: g.fontMetrics(f.style.fontSize, c).b - 3}, f), !1, "spacingBox"), !f.floating && !f.verticalAlign))
                b = c.getBBox().height;
            d && (d.css({width: (e.width || h) + "px"}).align(x({y: b + (f.margin - 13) + g.fontMetrics(f.style.fontSize, d).b}, e), !1, "spacingBox"), !e.floating && !e.verticalAlign && (b = za(b + d.getBBox().height)));
            ...
            a ? b && (this.renderTo.appendChild(c), Ta(b), delete this.renderToClone) : (c &&
                    c.parentNode === this.renderTo && this.renderTo.removeChild(c), this.renderToClone = b = this.renderTo.cloneNode(0), M(b, {position: "absolute", top: "-9999px", display: "block"}), b.style.setProperty && b.style.setProperty("display", "block", "important"), E.body.appendChild(b), c && b.appendChild(c))
            ...
            c = this.chartWidth;
            d = this.chartHeight;
            this.container = a = aa(Ua, {className: "highcharts-container" + (b.className ? " " + b.className : ""), id: e}, x({position: "relative", overflow: "hidden", width: c + "px", height: d + "px", textAlign: "left", lineHeight: "normal", zIndex: 0, "-webkit-tap-highlight-color": "rgba(0,0,0,0)"}, b.style), this.renderToClone || a);
            this._cursor = a.style.cursor;
            this.renderer =
                    b.forExport ? new na(a, c, d, b.style, !0) : new Wa(a, c, d, b.style);
            ...
            var b = this, c = b.options.chart, d = b.renderTo, e = c.width || pb(d, "width"), f = c.height || pb(d, "height"), c = a ? a.target : T, d = function() {
                if (b.container)
                    b.setSize(e, f, !1), b.hasUserSize = null
            };
            if (!b.hasUserSize && !b.isPrinting && e && f && (c === T || c === E)) {
                if (e !== b.containerWidth || f !== b.containerHeight)
                    clearTimeout(b.reflowTimeout), a ? b.reflowTimeout =
                            setTimeout(d, 100) : d();
                b.containerWidth = e;
                b.containerHeight = f
            }
            ...
            if (s(a))
                d.chartWidth = e = v(0, w(a)), d.hasUserSize = !!e;
            if (s(b))
                d.chartHeight = f = v(0, w(b));
            (Ga ? qb : M)(d.container, {width: e + "px", height: f +
                        "px"}, Ga);
            d.setChartSize(!0);
            ...
            b = za(v(d, h[3]) / 2);
            c = za(v(d, h[0]) / 2);
            this.clipBox = {x: b, y: c, width: X(this.plotSizeX - v(d, h[1]) / 2 - b), height: v(0, X(this.plotSizeY - v(d, h[2]) /
                        2 - c))};
            ...
            var a = this.options.chart, b = this.renderer, c = this.chartWidth, d = this.chartHeight, e = this.chartBackground, f = this.plotBackground, g = this.plotBorder, h = this.plotBGImage, i = a.borderWidth || 0, j = a.backgroundColor, k = a.plotBackgroundColor, l = a.plotBackgroundImage, m = a.plotBorderWidth ||
                    0, o, q = this.plotLeft, t = this.plotTop, p = this.plotWidth, n = this.plotHeight, u = this.plotBox, r = this.clipRect, s = this.clipBox;
            o = i + (a.shadow ? 8 : 0);
            if (i || j)
                if (e)
            ...
            if (k)
                f ? f.animate(u) : this.plotBackground = b.rect(q, t, p, n, 0).attr({fill: k}).add().shadow(a.plotShadow);
            if (l)
                h ? h.animate(u) :
                        this.plotBGImage = b.image(l, q, t, p, n).add();
            r ? r.animate({width: s.width, height: s.height}) : this.clipRect = b.clipRect(s);
            if (m)
                g ? g.animate(g.crisp({x: q, y: t, width: p, height: n, strokeWidth: -m})) : this.plotBorder = b.rect(q, t, p, n, 0, -m).attr({stroke: a.plotBorderColor, "stroke-width": m, fill: Z, zIndex: 1}).add();
            this.isDirtyBox = !1
            ...
            b.items && n(b.items, function(c) {
                var d = x(b.style, c.style), e = C(d.left) +
        ...
        destroy: function() {
            ...
            var a = this;
            return!ea && T == T.top && E.readyState !== "complete" || ma && !T.canvg ? (ma ? Tb.push(function() {
                a.firstRender()
    ...
    var fc = z.CenteredSeriesMixin = {getCenter: function() {
            var a = this.options,
                    b = this.chart, c = 2 * (a.slicedOffset || 0), d = b.plotWidth - 2 * c, b = b.plotHeight - 2 * c, e = a.center, e = [p(e[0], "50%"), p(e[1], "50%"), a.size || "100%", a.innerSize || 0], f = B(d, b), g, h, i;
            for (h = 0; h < 4; ++h)
                i = e[h], g = /%$/.test(i), a = h < 2 || h === 2 && g, e[h] = (g ? [d, b, f, e[2]][h] * C(i) / 100 : C(i)) + (a ? c : 0);
            return e
        }}, Ca = function() {
    };
    Ca.prototype = {init: function(a, b, c) {
            this.series = a;
            this.color = a.color;
    ...
    P.prototype = {isCartesian: !0, type: "line",
        pointClass: Ca, sorted: !0, requireSorting: !0, pointAttrToOptions: {stroke: "lineColor", "stroke-width": "lineWidth", fill: "fillColor", r: "radius"}, axisTypes: ["xAxis", "yAxis"], colorCounter: 0, parallelArrays: ["x", "y"], init: function(a, b) {
            ...
            if (d === "month" || d === "year")
                a = new fa(b), a = d === "month" ? +a[Cb](a[db]() + c) : +a[Db](a[eb]() + c), c = a - b;
            this.xIncrement = b + c;
            return b
            ...
            if ((c.negativeColor || c.negativeFillColor) && !c.zones)
                a.push({value: c[this.zoneAxis + "Threshold"] || c.threshold || 0, color: c.negativeColor,
            ...
            if (k && !this.isDirty && !h.isDirty && !this.yAxis.isDirty && !a)
                return!1;
            if (h)
                a = h.getExtremes(), l = a.min, m = a.max;
            if (k && this.sorted && (!i || d > i || this.forceCrop))
                if (b[d -
                1] < l || b[0] > m)
                    b = [], c = [];
                else if (b[0] < l || b[d - 1] > m)
                    e = this.cropData(this.xData, this.yData, l, m), b = e.xData, c = e.yData, e = e.start, f = !0;
            for (i = b.length - 1; i >= 0; i--)
                d = b[i] - b[i - 1], d > 0 && (g === r || d < g) ? g = d : d < 0 && this.requireSorting && qa(15);
            this.cropped = f;
            this.cropStart = e;
            ...
            for (m = 0; m < g; m++)
                i = h + m, j ? l[m] = (new f).init(this, [d[m]].concat(pa(e[m]))) : (b[i] ? k = b[i] : a[i] !== r && (b[i] = k = (new f).init(this, a[i], d[m])), l[m] = k), l[m].index = i;
            if (b && (g !== (c = b.length) || j))
                for (m =
                        0; m < c; m++)
                    if (m === h && !j && (m += g), b[m])
            ...
            for (var a = this.options, b = a.stacking, c = this.xAxis, d = c.categories, e = this.yAxis, f = this.points, g = f.length, h = !!this.modifyValue, i = a.pointPlacement, j = i === "between" || sa(i), k = a.threshold, l, m, o, q = Number.MAX_VALUE, a = 0; a < g; a++) {
                ...
                if (e.isLog && N !== null && N <= 0)
                    t.y = N = null, qa(10);
                t.plotX =
                        l = c.translate(n, 0, 0, 0, 1, i, this.type === "flags");
                if (b && this.visible && u && u[n])
                    u = u[n], N = u.points[this.index + "," + a], m = N[0], N = N[1], m === 0 && (m = p(k, e.min)), e.isLog && m <= 0 && (m = null), t.total = t.stackTotal = u.total, t.percentage = u.total && t.y / u.total * 100, t.stackY = N, u.setOffset(this.pointXOffset || 0, this.barW || 0);
            ...
            if (l.enabled !== !1 || this._hasPointMarkers)
                for (f = b.length; f--; )
                    if (g = b[f], d = X(g.plotX), e = g.plotY, k = g.graphic, o = g.marker || {}, q = !!g.marker, a = N && o.enabled === r || o.enabled, t = g.isInside, a && e !== r && !isNaN(e) && g.y !== null)
                        if (a = g.pointAttr[g.selected ? "select" : ""] || m, h = a.r, i = p(o.symbol,
                                this.symbol), j = i.indexOf("url") === 0, k)
                            k[t ? "show" : "hide"](!0).animate(x({x: d - h, y: e - h}, k.symbolName ? {width: 2 * h, height: 2 * h} : {}));
                        else {
                            if (t && (h > 0 || j))
                                g.graphic = c.renderer.symbol(i, d - h, e - h, 2 * h, 2 * h, q ? o : l).attr(a).add(n)
                        }
                    else if (k)
                        g.graphic = k.destroy()
            ...
            var a = this, b = a.options, c = V[a.type].marker ? b.marker : b, d = c.states, e = d.hover,
            ...
            if (!j || g < j || l)
                for (; g--; ) {
                    ...
                    if (l) {
                        ...
                        f = d.hover = d.hover || {};
                        if (!b.marker)
                            f.color = f.color || !j.options.color && e[j.negative && h ? "negativeColor" : "color"] || wa(j.color).brighten(f.brightness ||
                                    e.brightness).get();
                        f = {color: j.color};
                        if (!q)
                            f.fillColor = j.color;
            ...
            var a = this, b = a.chart, c = /AppleWebKit\/533/.test(Ha), d, e, f = a.data || [], g, h, i;
            K(a, "destroy");
            U(a);
            n(a.axisTypes || [], function(b) {
                if (i = a[b])
                    ua(i.series, a), i.isDirty = i.forceRedraw = !0
            });
            ...
            var a = this, b = this.chart, c = b.renderer, d = this.zones, e, f, g = this.clips || [], h, i = this.graph,
                    j = this.area, k = v(b.chartWidth, b.chartHeight), l = this[(this.zoneAxis || "y") + "Axis"], m = l.reversed, o = l.horiz, q = !1;
            if (d.length && (i || j))
                i.hide(), j && j.hide(), n(d, function(d, i) {
                    e = p(f, m ? o ? b.plotWidth : 0 : o ? 0 : l.toPixels(l.min));
                    f = w(l.toPixels(p(d.value, l.max), !0));
                    q && (e = f = l.toPixels(l.max));
                    if (l.isXAxis) {
                        if (h = {x: m ? f : e, y: 0, width: Math.abs(e - f), height: k}, !o)
                            h.x = b.plotHeight - h.x
                    } else if (h = {x: 0, y: m ? e : f, width: k, height: Math.abs(e - f)}, o)
                        h.y = b.plotWidth - h.y;
                    b.inverted && c.isVML && (h = l.isXAxis ? {x: 0, y: m ? e : f, height: h.width,
        ...
        kdAxisArray: ["plotX", "plotY"], kdComparer: "distX", searchPoint: function(a) {
            ...
            function b(a, h, i, j) {
                ...
                m = {distX: s(m) ? Math.sqrt(m) : Number.MAX_VALUE, distY: s(q) ? Math.sqrt(q) : Number.MAX_VALUE, distR: s(t) ? Math.sqrt(t) : Number.MAX_VALUE};
                k.dist = m;
                l = a[l] - k[l];
                m = l < 0 ? "left" : "right";
    ...
    Qb.prototype = {destroy: function() {
            ...
            var c = this.axis, d = c.chart, e = d.inverted, f = this.isNegative, g = c.translate(c.usePercentage ? 100 : this.total, 0, 0, 0, 1), c = c.translate(0), c = R(g - c), h = d.xAxis[0].translate(this.x) + a, i = d.plotHeight, f = {x: e ? f ? g : g - c : h, y: e ? i - h - b : f ? i - g - c : i - g, width: e ? c : b, height: e ? b : c};
            if (e = this.label)
        ...
        if (this.options.stacking && !(this.visible !== !0 && this.chart.options.chart.ignoreHiddenSeries !== !1)) {
            ...
            for (p = 0; p < d; p++) {
                ...
                l[q] || (l[q] =
                        {});
                if (!l[q][n])
                    m[q] && m[q][n] ? (l[q][n] = m[q][n], l[q][n].total = null) : l[q][n] = new Qb(k, k.options.stackLabels, o, n, g);
                q = l[q][n];
                q.points[t] = [q.cum || 0];
        ...
        n([b, "-" + b], function(b) {
            ...
            for (var f = d.length, g, h; f--; )
                if (g = d[f], e = (h = c[b] && c[b][g]) && h.points[a.index + "," + f], g = e)
                    h = h.total ? 100 / h.total : 0, g[0] = la(g[0] * h), g[1] = la(g[1] * h), a.stackedYData[f] = g[1]
        })
    };
    x(Pa.prototype, {addSeries: function(a, b, c) {
            var d, e = this;
            ...
            new O(this, y(a, {index: this[e].length,
                isX: b}));
            f[e] = pa(f[e] || {});
            f[e].push(a);
            p(c, !0) && this.redraw(d)
            ...
            if (!d)
                b.loadingDiv = d = aa(Ua, {className: "highcharts-loading"}, x(e.style, {zIndex: 10, display: Z}), b.container), b.loadingSpan = aa("span", null, e.labelStyle, d), D(b, "redraw", f);
    ...
    x(Ca.prototype, {update: function(a, b, c, d) {
            function e() {
                f.applyOptions(a);
                if (ia(a) && !Ka(a))
                    f.redraw = function() {
            ...
            this.series.removePoint(Oa(this, this.series.data),
                    a, b)
        }});
    ...
    var ya = ja(P, {type: "area", getSegments: function() {
            var a =
                    ...
                    if (!l || h[b] && h[b].y !== null)
                        if (h[b])
                            ...
                            c.push({y: null, plotX: i, clientX: i,
                                plotY: j, yBottom: j, onMouseOver: ha})
                        }
                });
                c.length && b.push(c)
            } else
                P.prototype.getSegments.call(this), b = this.segments;
            this.segments = b
        }, getSegmentPath: function(a) {
            ...
            n(d, function(d) {
                var f = d[0], g = a[f];
                g ? g.animate({d: b}) : a[f] = a.chart.renderer.path(b).attr({fill: p(d[2], wa(d[1]).setOpacity(p(c.fillOpacity, 0.75)).get()),
                    zIndex: 0}).add(a.group)
            })
        }, drawLegendSymbol: G.drawRectangle});
    I.area = ya;
    V.spline = y(Q);
    Da = ja(P, {type: "spline", getPointSpline: function(a, b, c) {
    ...
    ya = ya.prototype;
    Da = ja(Da, {type: "areaspline", closedStacks: !0, getSegmentPath: ya.getSegmentPath, closeSegment: ya.closeSegment, drawGraph: ya.drawGraph, drawLegendSymbol: G.drawRectangle});
    I.areaspline = Da;
    V.column = y(Q, {borderColor: "#FFFFFF", borderRadius: 0, groupPadding: 0.2, marker: null, pointPadding: 0.1, minPointLength: 0, cropThreshold: 50, pointRange: null, states: {hover: {brightness: 0.1,
    ...
    Da = ja(P, {type: "column", pointAttrToOptions: {stroke: "borderColor", fill: "color", r: "borderRadius"}, cropShoulder: 0, directTouch: !0, trackerGroups: ["group", "dataLabelsGroup"], negStacks: !0, init: function() {
            ...
            b.grouping === !1 ? i = 1 : n(a.chart.series, function(b) {
                ...
                if (b.type === a.type && b.visible && d.len === e.len && d.pos === e.pos)
                    c.stacking ? (f = b.stackKey, g[f] === r && (g[f] = i++), h = g[f]) : c.grouping !== !1 && (h = i++), b.columnIndex = h
            });
        ...
        }, getSymbol: ha, drawLegendSymbol: G.drawRectangle,
        drawGraph: ha, drawPoints: function() {
            ...
            n(a.points, function(h) {
                ...
                if (i !== r && !isNaN(i) && h.y !== null)
                    f = h.shapeArgs, i = s(a.borderWidth) ? {"stroke-width": a.borderWidth} : {}, g = h.pointAttr[h.selected ? "select" : ""] || a.pointAttr[""], j ? (ab(j), j.attr(i)[b.pointCount < e ? "animate" : "attr"](y(f))) : h.graphic = d[h.shapeType](f).attr(i).attr(g).add(a.group).shadow(c.shadow, null, c.stacking && !c.borderRadius);
                else if (j)
                    h.graphic =
                            j.destroy()
            })
            ...
            if (ea)
                a ? (e.scaleY = 0.001, a = B(b.pos + b.len, v(b.pos, b.toPixels(c.threshold))), d ? e.translateX = a - b.len : e.translateY = a, this.group.attr(e)) : (e.scaleY = 1, e[d ? "translateX" : "translateY"] = b.pos, this.group.animate(e, this.options.animation), this.animate = null)
        }, remove: function() {
            var a = this, b = a.chart;
            b.hasRendered && n(b.series, function(b) {
                if (b.type === a.type)
    ...
    I.bar = ya;
    V.scatter = y(Q, {lineWidth: 0, marker: {enabled: !0}, tooltip: {headerFormat: '<span style="color:{series.color}">●</span> <span style="font-size: 10px;"> {series.name}</span><br/>', pointFormat: "x: <b>{point.x}</b><br/>y: <b>{point.y}</b><br/>"}});
    ya = ja(P, {type: "scatter", sorted: !1, requireSorting: !1, noSharedTooltip: !0, trackerGroups: ["group", "markerGroup", "dataLabelsGroup"], takeOrdinalPosition: !1, kdDimensions: 2, kdComparer: "distR", drawGraph: function() {
            this.options.lineWidth &&
                    P.prototype.drawGraph.call(this)
        }});
    I.scatter = ya;
    V.pie = y(Q, {borderColor: "#FFFFFF", borderWidth: 1, center: [null, null], clip: !1, colorByPoint: !0, dataLabels: {distance: 30, enabled: !0, formatter: function() {
    ...
    Q = {type: "pie", isCartesian: !1, pointClass: ja(Ca, {init: function() {
            ...
            }}), requireSorting: !1, noSharedTooltip: !0, trackerGroups: ["group", "dataLabelsGroup"], axisTypes: [], pointAttrToOptions: {stroke: "borderColor", "stroke-width": "borderWidth", fill: "color"}, getColor: ha, animate: function(a) {
            ...
            for (m = 0; m < o; m++) {
                ...
                q.angle = h;
                e = B(e, l / 2);
                q.labelPos = [a[0] + f + ba(h) * l, a[1] + g + ga(h) * l, a[0] + f + ba(h) * e, a[1] + g + ga(h) * e, a[0] + f, a[1] + g, l < 0 ? "center" : q.half ? "right" : "left", h]
            }
        ...
        }, drawLegendSymbol: G.drawRectangle, getCenter: fc.getCenter, getSymbol: ha};
    Q = ja(P, Q);
    I.pie = Q;
    P.prototype.drawDataLabels = function() {
        ...
        if (d.enabled || a._hasPointLabels)
            a.dlProcessOptions && a.dlProcessOptions(d), j = a.plotGroup("dataLabelsGroup", "data-labels", d.defer ? "hidden" : "visible", d.zIndex || 6), p(d.defer, !0) &&
                ...
                if (o && !h)
                    ...
                    if (o)
                        ...
                        if (u.color === "contrast")
                            v.color = d.inside || d.distance < 0 || b.stacking ? k.getContrast(e.color || a.color) : "#000000";
                        if (c)
                            v.cursor = c;
                        for (t in o)
                            o[t] === r && delete o[t];
    ...
    P.prototype.alignDataLabel = function(a, b, c, d, e) {
        ...
        if (l)
            d = x({x: g ? f.plotWidth - i : h, y: w(g ? f.plotHeight - h : i), width: 0, height: 0}, d), x(c, {width: j.width, height: j.height}), c.rotation ? (a = f.renderer.rotCorr(k, c.rotation), b[e ? "attr" : "animate"]({x: d.x + c.x + d.width / 2 + a.x,
    ...
    if (I.pie)
            ...
            if (a.visible && (e.enabled || a._hasPointLabels)) {
                ...
                for (E = 2; E--; ) {
                    ...
                    if (K) {
                        ...
                        for (L = b = 0; !b && H[L]; )
                            b = H[L] && H[L].dataLabel && (H[L].dataLabel.getBBox().height || 21), L++;
                        if (m > 0) {
                            u = B(t + q + m, d.plotHeight);
                            for (L = v(0, t - q - m); L <= u; L += b)
                                G.push(L);
                            u = G.length;
                            if (K > u) {
                                c = [].concat(H);
                            ...
                            for (L = 0; L < K; L++) {
                                ...
                                if (F < L && G[L] !== null)
                                    ...
                                    for (u < K - L + F && G[L] !== null && (F = u - K + L); G[F] === null; )
                                        F++;
                                M.push({i: F, y: G[F]});
                                G[F] = null
                            }
                        ...
                        for (L = 0; L < K; L++) {
                            ...
                            c = A[1];
                            if (m > 0) {
                                if (u = M.pop(), F = u.i, z = u.y, c > z && G[F + 1] !== null || c < z && G[F - 1] !== null)
                            ...
                            if (this.options.size === null)
                                u = r.width, y - u < f ? C[3] = v(w(u - y + f), C[3]) : y + u > h - f && (C[1] = v(w(y + u - h + f), C[1])), z - b / 2 < 0 ? C[0] = v(w(-z + b / 2), C[0]) : z + b / 2 > i && (C[2] = v(w(z + b / 2 - i), C[2]))
                        }
                    }
                }
        ...
        }, I.pie.prototype.alignDataLabel = ha, I.pie.prototype.verifyDataLabelOverflow = function(a) {
    ...
    if (I.column)
        I.column.prototype.alignDataLabel = function(a, b, c, d, e) {
            ...
            if (h && (d = y(h), f && (d = {x: g.yAxis.len - d.y - d.height, y: g.xAxis.len - d.x - d.width, width: d.height, height: d.width}), !j))
    ...
    var jb = z.TrackerMixin = {drawTrackerPoint: function() {
            ...
            j ? j.attr({d: d}) : (a.tracker = h.path(d).attr({"stroke-linejoin": "round", visibility: a.visible ? "visible" : "hidden", stroke: q, fill: c ? q : Z, "stroke-width": b.lineWidth + (c ? 0 : 2 * i), zIndex: 2}).add(a.group), n([a.tracker, a.markerGroup], function(a) {
    ...
    if (I.column)
        Da.prototype.drawTracker = jb.drawTrackerPoint;
    if (I.pie)
        I.pie.prototype.drawTracker = jb.drawTrackerPoint;
    if (I.scatter)
        ya.prototype.drawTracker = jb.drawTrackerPoint;
    ...
    x(Pa.prototype, {showResetZoom: function() {
            var a = this, b = F.lang, c = a.options.chart.resetZoomButton,
            ...
            n(b === "xy" ? [1, 0] : [1], function(b) {
                ...
                if (h.series.length && (i || l > B(k.dataMin, k.min)) && (!i || j < v(k.dataMax, k.max)))
    ...
    x(Ca.prototype, {select: function(a, b) {
            ...
            var c = this.plotX, d = this.plotY, e = this.series, f = e.options.states, g = V[e.type].marker && e.options.marker, h = g && !g.enabled, i = g && g.states[a], j = i && i.enabled === !1, k = e.stateMarkerGraphic, l =
                    this.marker || {}, m = e.chart, o = e.halo, q, a = a || "";
            ...
            if (!(a === this.state && !b || this.selected && a !== "select" || f[a] && f[a].enabled === !1 || a && (j || h && i.enabled === !1) || a && l.states && l.states[a] && l.states[a].enabled === !1)) {
                if (this.graphic)
                    g = g && this.graphic.symbolName && q.r, this.graphic.attr(y(q, g ? {x: c - g, y: d - g, width: 2 * g, height: 2 * g} : {})), k && k.hide();
                else {
                    if (a && i)
                        if (g = i.radius, l = l.symbol || e.symbol, k && k.currentSymbol !== l && (k = k.destroy()), k)
                            ...
                            e.stateMarkerGraphic =
                                    k = m.renderer.symbol(l, c - g, d - g, 2 * g, 2 * g).attr(q).add(e.markerGroup), k.currentSymbol = l;
                    if (k)
    ...
    x(P.prototype, {onMouseOver: function() {
            ...
            this.selected = a = a === r ? !this.selected :
                    a;
            if (this.checkbox)
    ...
    S(O.prototype, "getTimeTicks", function(a, b, c, d, e, f, g, h) {
        ...
        if (!this.options.ordinal && !this.options.breaks || !f || f.length < 3 || c === r)
            return a.call(this,
                    b, c, d, e);
        ...
        if (h && s(p)) {
            ...
            h = t[a - 1] > d ? a - 1 : a;
            for (u = void 0; h--; )
                i = j[h], d = u - i, u && d < p * 0.8 && (m === null || d < m * 0.8) ? (l[t[h]] && !l[t[h + 1]] ? (d = h + 1, u = i) : d = h, t.splice(d, 1)) : u = i
        }
        return t
    });
    x(O.prototype, {beforeSetTickPositions: function() {
            ...
            if (a.options.ordinal || a.options.breaks) {
                ...
                if (b > 2) {
                    ...
                    for (h = b - 1; h-- && !d; )
                        c[h + 1] - c[h] !== e && (d = !0);
                    if (!a.options.keepOrdinalPadding && (c[0] - g > e || f - c[c.length - 1] > e))
                        d = !0
                }
            ...
            if (!c[d])
                f = {series: [], getExtremes: function() {
                    ...
                    }, options: {ordinal: !0}, val2lin: O.prototype.val2lin}, n(this.series, function(c) {
        ...
        if (c.options.ordinal && c.series.length) {
            ...
            if (m.ordinalPositions) {
                if (R(f) > 1)
                    k && n(k, function(a) {
                        a.setState()
                    }), f < 0 ? (k = m, q = c.ordinalPositions ? c : m) : (k = c.ordinalPositions ? c : m, q = m), m = q.ordinalPositions, h >
                            m[m.length - 1] && m.push(h), this.fixedRange = j - i, f = c.toFixedRange(null, null, l.apply(k, [o.apply(k, [i, !0]) + f, !0]), l.apply(q, [o.apply(q, [j, !0]) + f, !0])), f.min >= B(g.dataMin, i) && f.max <= v(h, j) && c.setExtremes(f.min, f.max, !0, !1, {trigger: "pan"}), this.mouseDownX = d, M(this.container, {cursor: "move"})
            } else
                e = !0
        } else
            e = !0;
    ...
    (function(a) {
        ...
        e(g.prototype, {isInBreak: function(a, b) {
                ...
                "init", function(a, b, c) {
                    ...
                    if (this.options.breaks) {
                        ...
                        this.lin2val = function(a) {
                            ...
                            for (c = 0; c < d.breakArray.length; c++)
                                if (b = d.breakArray[c], b.from >= a)
                                    ...
                                    b.to < a ? a += b.to - b.from : d.isInBreak(b, a) && (a += b.to - b.from);
                            return a
                        };
                        ...
                        this.setAxisTranslation = function(a) {
                            ...
                            for (p in b)
                                i = b[p], d.isInBreak(i, j) && (j += i.to % i.repeat - j % i.repeat), d.isInBreak(i, k) && (k -= k % i.repeat - i.from % i.repeat);
                            for (p in b) {
                                i = b[p];
                                n = i.from;
                                for (h =
                                        i.repeat || Infinity; n - h > j; )
                                    n -= h;
                                for (; n < j; )
                                    n += h;
                                for (; n < k; n += h)
                                    a.push({value: n, move: "in"}), a.push({value: n + (i.to - i.from), move: "out", size: i.breakSize})
                            }
                            a.sort(function(a, b) {
    ...
    Vb = [["millisecond", [1, 2, 5, 10, 20, 25, 50, 100, 200, 500]], ["second", [1, 2, 5, 10, 15, 30]], ["minute", [1, 2, 5, 10, 15, 30]], ["hour", [1, 2, 3, 4, 6, 8, 12]], ["day", [1]], ["week", [1]], ["month", [1, 3, 6]], ["year", null]], Qa = {sum: function(a) {
            var b = a.length, c;
            if (!b && a.hasNulls)
                c = null;
            else if (b)
    ...
    da.groupData = function(a, b, c, d) {
        ...
        for (; n <= i; n++) {
            for (; c[1] !== r && a[n] >= c[1] || n === i; )
                if (j = c.shift(), k = d.apply(0, m), k !== r && (g.push(j), h.push(k)), m[0] = [], m[1] = [], m[2] = [], m[3] = [], n === i)
                    break;
            if (n === i)
                break;
            if (o) {
                ...
                for (k = 0; k < q; k++)
                    if (p = j[o[k]], typeof p === "number")
                        ...
                        m[k].hasNulls = !0
            } else if (j = l ? b[n] : null, typeof j === "number")
                m[0].push(j);
            else if (j === null)
                m[0].hasNulls = !0
        }
    ...
    da.processData = function() {
        ...
        if (gc.apply(this, arguments) !== !1 && d) {
            ...
            if (j) {
                ...
                this.points =
                        null;
                var k = a.getExtremes(), d = k.min, k = k.max, i = i && a.getGroupIntervalFactor(d, k, this) || 1, h = j * (k - d) / h * i, j = a.getTimeTicks(a.normalizeTimeTickInterval(h, c.units || Vb), d, k, a.options.startOfWeek, f, this.closestPointRange), g = da.groupData.apply(this, [f, g, j, c.approximation]), f = g[0], g = g[1];
                if (c.smoothed) {
                    c = f.length - 1;
                    for (f[c] = k; c-- && c > 0; )
                        f[c] += h / 2;
    ...
    S(da, "setOptions",
            function(a, b) {
                ...
                if (Ub[d])
                    f || (f = y(kc, Ub[d])), c.dataGrouping = y(f, e.series && e.series.dataGrouping, e[d].dataGrouping, b.dataGrouping);
    ...
    V.ohlc = y(V.column, {lineWidth: 1, tooltip: {pointFormat: '<span style="color:{point.color}">●</span> <b> {series.name}</b><br/>Open: {point.open}<br/>High: {point.high}<br/>Low: {point.low}<br/>Close: {point.close}<br/>'}, states: {hover: {lineWidth: 3}}, threshold: null});
    Q = ja(I.column, {type: "ohlc",
        pointArrayMap: ["open", "high", "low", "close"], toYData: function(a) {
            ...
            n(a.points, function(k) {
                if (k.plotY !== r)
                    i = k.graphic, c = k.pointAttr[k.selected ? "selected" : ""] || a.pointAttr[""], f = c["stroke-width"] % 2 / 2, j = w(k.plotX) - f, g = w(k.shapeArgs.width / 2), h = ["M", j, w(k.yBottom), "L", j, w(k.plotY)], k.open !==
                            null && (d = w(k.plotOpen) + f, h.push("M", j, d, "L", j - g, d)), k.close !== null && (e = w(k.plotClose) + f, h.push("M", j, e, "L", j + g, e)), i ? i.attr(c).animate({d: h}) : k.graphic = b.renderer.path(h).attr(c).add(a.group)
            })
        }, animate: null});
    I.ohlc = Q;
    V.candlestick = y(V.column, {lineColor: "black", lineWidth: 1, states: {hover: {lineWidth: 2}}, tooltip: V.ohlc.tooltip, threshold: null, upColor: "white"});
    Q = ja(Q, {type: "candlestick", pointAttrToOptions: {fill: "color", stroke: "lineColor", "stroke-width": "lineWidth"}, upColorProp: "fill", getAttribs: function() {
            ...
            n(a.points, function(n) {
                m = n.graphic;
                if (n.plotY !== r)
                    c = n.pointAttr[n.selected ? "selected" : ""] || d, k = c["stroke-width"] % 2 / 2, l = w(n.plotX) - k, e = n.plotOpen, f = n.plotClose, g = Y.min(e,
                            f), h = Y.max(e, f), q = w(n.shapeArgs.width / 2), i = w(g) !== w(n.plotY), j = h !== n.yBottom, g = w(g) + k, h = w(h) + k, o = ["M", l - q, h, "L", l - q, g, "L", l + q, g, "L", l + q, h, "Z", "M", l, g, "L", l, i ? w(n.plotY) : g, "M", l, h, "L", l, j ? w(n.yBottom) : h], m ? m.attr(c).animate({d: o}) : n.graphic = b.renderer.path(o).attr(c).add(a.group).shadow(a.options.shadow)
            })
        }});
    I.candlestick = Q;
    var sb = na.prototype.symbols;
    V.flags = y(V.column, {fillColor: "white", lineWidth: 1, pointRange: 0, shape: "flag", stackDistance: 12, states: {hover: {lineColor: "black", fillColor: "#FCFFC5"}},
    ...
    I.flags = ja(I.column, {type: "flags", sorted: !1, noSharedTooltip: !0, allowDG: !1, takeOrdinalPosition: !1, trackerGroups: ["markerGroup"], forceCrop: !0, init: P.prototype.init, pointAttrToOptions: {fill: "fillColor", stroke: "color", "stroke-width": "lineWidth", r: "radius"}, translate: function() {
            ...
            var a = this.chart, b = this.points, c = b.length - 1, d, e, f = this.options.onSeries,
                    f = (d = f && a.get(f)) && d.options.step, g = d && d.points, h = g && g.length, i = this.xAxis, j = i.getExtremes(), k, l, m;
            if (d && d.visible && h) {
                ...
                for (b.sort(function(a, b) {
                    ...
                    if (d = b[c], k = g[h], k.x <= d.x && k.plotY !== r) {
                        if (d.x <= l)
                            d.plotY = k.plotY, k.x < d.x && !f && (m = g[h + 1]) && m.plotY !== r && (d.plotY += (d.x - k.x) / (m.x - k.x) * (m.plotY - k.plotY));
                        c--;
                        h++;
                        if (c < 0)
                            break
            ...
            n(b, function(c, d) {
                var f;
                if (c.plotY === r)
                    c.x >= j.min && c.x <= j.max ? c.plotY = a.chartHeight - i.bottom - (i.opposite ?
                            i.height : 0) + i.offset - a.plotTop : c.shapeArgs = {};
            ...
            for (j = c.length; j--; )
                if (k = c[j], a = k.plotX > this.xAxis.len, e = k.plotX + (a ? m : -m), l = k.stackIndex, i = k.options.shape || g.shape, f = k.plotY, f !== r && (f = k.plotY + h + m - (l !== r && l * g.stackDistance)), o = l ? r : k.plotX + m, n = l ? r : k.plotY, l = k.graphic,
                        f !== r && e >= 0 && !a)
                    a = k.pointAttr[k.selected ? "select" : ""] || b, l ? l.attr({x: e, y: f, r: a.r, anchorX: o, anchorY: n}) : k.graphic = d.label(k.options.title || g.title || "A", e, f, i, o, n, g.useHTML).css(y(g.style, k.style)).attr(a).attr({align: i === "flag" ? "left" : "center", width: g.width, height: g.height}).add(this.markerGroup).shadow(g.shadow), k.tooltipPos = [e, f];
                else if (l)
                    k.graphic = l.destroy()
        ...
        }, animate: ha, buildKDTree: ha, setClip: ha});
    ...
    Q[4] = ["day", [1, 2, 3, 4]];
    Q[5] = ["week", [1, 2, 3]];
    x(F, {navigator: {handles: {backgroundColor: "#ebe7e8", borderColor: "#b2b1b6"}, height: 40, margin: 25, maskFill: "rgba(128,179,236,0.3)", maskInside: !0, outlineColor: "#b2b1b6", outlineWidth: 1, series: {type: I.areaspline === r ? "line" : "areaspline", color: "#4572A7", compare: null,
    ...
    Eb.prototype = {drawHandle: function(a, b) {
            ...
            if (!isNaN(a)) {
                ...
                if (!(l.translate(d, !0) - l.translate(c, !0) < e.xAxis[0].minRange)) {
                    ...
                    if (!this.rendered) {
                        if (y)
                            this.navigatorGroup = l = f.g("navigator").attr({zIndex: 3}).add(), this.leftShade = f.rect().attr({fill: r.maskFill}).add(l), r.maskInside ? this.leftShade.css({cursor: "ew-resize "}) : this.rightShade = f.rect().attr({fill: r.maskFill}).add(l), this.outline = f.path().attr({"stroke-width": z, stroke: r.outlineColor}).add(l);
                        if (t)
                            this.scrollbarGroup = k = f.g("scrollbar").add(), m = s.trackBorderWidth, this.scrollbarTrack = o = f.rect().attr({x: 0,
                                y: -m % 2 / 2, fill: s.trackBackgroundColor, stroke: s.trackBorderColor, "stroke-width": m, r: s.trackBorderRadius || 0, height: n}).add(k), this.scrollbar = m = f.rect().attr({y: -G % 2 / 2, height: n, fill: s.barBackgroundColor, stroke: s.barBorderColor, "stroke-width": G, r: H}).add(k), this.scrollbarRifles = f.path().attr({stroke: s.rifleColor, "stroke-width": 1}).add(k)
                    }
                    e = e.isResizing ? "animate" : "attr";
                    if (y) {
                        this.leftShade[e](r.maskInside ? {x: g + b, y: x, width: c - b, height: A} : {x: g, y: x, width: b, height: A});
                        if (this.rightShade)
                            this.rightShade[e]({x: g +
                    ...
                    if (t && k)
                        this.drawScrollbarButton(0), this.drawScrollbarButton(1), k[e]({translateX: i, translateY: w(F + A)}), o[e]({width: j}), g = n + b, h = a - G, h < u && (D = (u - h) / 2, h = u, g -= D), this.scrollbarPad = D, m[e]({x: X(g) + G % 2 / 2, width: h}), u = n + b + a / 2 - 0.5, this.scrollbarRifles.attr({visibility: a > 12 ? "visible" : "hidden"})[e]({d: ["M",
            ...
            a.mouseDownHandler = function(d) {
                var d = b.pointer.normalize(d), e = a.zoomedMin, f = a.zoomedMax, h = a.top, j = a.scrollbarHeight, k = a.scrollerLeft, l = a.scrollerWidth, m = a.navigatorLeft, n = a.navigatorWidth, p = a.scrollbarPad, r = a.range, s = d.chartX, v = d.chartY, d = b.xAxis[0], w, x = fb ? 10 : 7;
                if (v > h && v < h + g + j)
                    if ((h =
                            !a.scrollbarEnabled || v < h + g) && Y.abs(s - e - m) < x)
                        ...
                        if (f !== e)
                            a.fixedWidth = r, e = c.toFixedRange(f, f + r, null, w), d.setExtremes(e.min, e.max,
            ...
            a.mouseMoveHandler = function(c) {
                ...
                if (c.pageX !== 0)
                    c = b.pointer.normalize(c), l = c.chartX, l < e ? l = e : l > g + h - d && (l = g + h - d), a.grabbedLeft ? (j = !0, a.render(0, 0, l - e, a.otherHandlePos)) : a.grabbedRight ? (j = !0, a.render(0, 0, a.otherHandlePos, l - e)) : a.grabbedCenter && (j = !0, l < i ? l = i : l > f + i - k && (l = f + i - k), a.render(0, 0, l - i, l - i + k)), j && a.scrollbarOptions.liveRedraw && setTimeout(function() {
                        a.mouseUpHandler(c)
                    },
                            0)
            };
            ...
            if (!a || b.dataMin !== null)
                return{dataMin: tb("min", d && d.min, e.min, b.dataMin, c.dataMin), dataMax: tb("max", d && d.max, e.max, b.dataMax, c.dataMax)}
    ...
    x(F, {rangeSelector: {buttonTheme: {width: 28, height: 18, fill: "#f7f7f7", padding: 2, r: 0, "stroke-width": 0, style: {color: "#444", cursor: "pointer", fontWeight: "normal"}, zIndex: 7, states: {hover: {fill: "#e7e7e7"},
    ...
    Fb.prototype = {clickButton: function(a, b) {
            var c = this, d = c.selected, e = c.chart, f = c.buttons, g = c.buttonOptions[a], h = e.xAxis[0], i = e.scroller && e.scroller.getUnionExtremes() || h || {}, j = i.dataMin, k = i.dataMax, l, m = h && w(B(h.max, p(k, h.max))), o = new fa(m), q = g.type, t = g.count, i = g._range, s;
            if (!(j === null || k ===
                    null || a === c.selected)) {
                if (q === "month" || q === "year")
                    l = {month: "Month", year: "FullYear"}[q], o["set" + l](o["get" + l]() - t), l = o.getTime(), j = p(j, Number.MIN_VALUE), isNaN(l) || l < j ? (l = j, m = B(l + i, k)) : i = m - l;
                else if (i)
                    l = v(m - i, j), m = B(l + i, k);
                else if (q === "ytd")
                    if (h) {
                ...
                f[a] && f[a].setState(2);
                e.fixedRange = i;
                h ? h.setExtremes(l, m, p(b, 1), 0, {trigger: "rangeSelectorButton", rangeSelectorButton: g}) : (d = e.options.xAxis, d[0] = y(d[0], {range: i, min: s}));
                c.setSelected(a)
            }
        ...
        init: function(a) {
            ...
            this[a + "DateBox"].attr({text: ka(c.inputDateFormat || "%b %e, %Y", this[a +
                        "Input"].HCTime)})
            ...
            l.offset += j.width + 5;
            this[a + "DateBox"] = k = e.label("", l.offset).attr({padding: 2, width: f.inputBoxWidth || 90, height: f.inputBoxHeight || 17, stroke: f.inputBoxBorderColor || "silver", "stroke-width": 1}).css(y({textAlign: "center",
                color: "#444"}, d, f.inputStyle)).on("click", function() {
                b[a + "Input"].focus()
            }).add(l);
            l.offset += k.width + (h ? 10 : 0);
            this[a + "Input"] = i = aa("input", {name: a, className: "highcharts-range-selector", type: "text"}, x({position: "absolute", border: 0, width: "1px", height: "1px", padding: 0, textAlign: "center", fontSize: d.fontSize, fontFamily: d.fontFamily, top: c.plotTop + "px"}, f.inputStyle), g);
            i.onfocus = function() {
                M(this, {left: l.translateX + k.x + "px", top: l.translateY + "px", width: k.width - 2 + "px", height: k.height - 2 + "px", border: "2px solid silver"})
            };
            i.onblur = function() {
            ...
            i.onchange = function() {
                ...
                isNaN(d) || (F.global.useUTC || (d += (new fa).getTimezoneOffset() * 6E4), h ? d > b.maxInput.HCTime ? d = r : d < g && (d = g) : d < b.minInput.HCTime ? d = r : d > j && (d = j), d !== r && c.xAxis[0].setExtremes(h ? d : e.min, h ? e.max : d, r, r, {trigger: "rangeSelectorInput"}))
            }
        }, render: function(a, b) {
            var c =
            ...
            if (!c.rendered && (c.group = u = e.g("range-selector-buttons").add(), c.zoomText = e.text(k.rangeSelectorZoom, p(m.x, t), p(m.y, d.plotTop - 35) + 15).css(i.labelStyle).add(u), r = p(m.x, t) + c.zoomText.getBBox().width + 5, v = p(m.y, d.plotTop - 35), n(c.buttonOptions,
                ...
                c.div = g = aa("div", null, {position: "relative", height: 0, zIndex: 1}), f.parentNode.insertBefore(g, f), c.inputGroup = g = e.g("input-group").add(), g.offset = 0, c.drawInput("min"), c.drawInput("max");
            o !== !1 && (f = d.plotTop - 45, g.align(x({y: f, width: g.offset, x: h && f < (h.y ||
                        0) + h.height - d.spacing[0] ? -40 : 0}, i.inputPosition), !0, d.spacingBox), s(o) || (d = u.getBBox(), g[g.translateX < d.x + d.width + 10 ? "hide" : "show"]()), c.setInputValue("min", a), c.setInputValue("max", b));
            c.rendered = !0
        }, destroy: function() {
            ...
            for (e in this)
                this[e] && e !== "chart" && (this[e].destroy ? this[e].destroy() :
    ...
    S(Pa.prototype, "init", function(a, b, c) {
        D(this, "init", function() {
            if (this.options.rangeSelector.enabled)
                this.rangeSelector = new Fb(this)
        });
        a.call(this, b, c)
    });
    z.RangeSelector = Fb;
    ...
    z.StockChart = function(a, b) {
        var c = a.series, d, e = p(a.navigator && a.navigator.enabled, !0) ? {startOnTick: !1, endOnTick: !1} : null, f = {marker: {enabled: !1, radius: 2}, states: {hover: {lineWidth: 2}}}, g = {shadow: !1, borderWidth: 0};
        a.xAxis = Aa(pa(a.xAxis || {}), function(a) {
            return y({minPadding: 0, maxPadding: 0, ordinal: !0, title: {text: null}, labels: {overflow: "justify"}, showLastLabel: !0}, a, {type: "datetime", categories: null}, e)
        });
        a.yAxis = Aa(pa(a.yAxis || {}), function(a) {
            d = p(a.opposite, !0);
            return y({labels: {y: -2},
                opposite: d, showLastLabel: !1, title: {text: null}}, a)
        });
        a.series = null;
        a = y({chart: {panning: !0, pinchType: "x"}, navigator: {enabled: !0}, scrollbar: {enabled: !0}, rangeSelector: {enabled: !0}, title: {text: null, style: {fontSize: "16px"}}, tooltip: {shared: !0, crosshairs: !0}, legend: {enabled: !1}, plotOptions: {line: f, spline: f, area: f, areaspline: f, arearange: f, areasplinerange: f, column: g, columnrange: g, candlestick: g, ohlc: g}}, a, {_stock: !0, chart: {inverted: !1}});
        a.series = c;
        return new Pa(a, b)
    };
    S(Xa.prototype, "init", function(a, b, c) {
    ...
    S(O.prototype, "getPlotLinePath", function(a, b, c, d, e, f) {
        ...
        y = g.isXAxis ? s(g.options.yAxis) ? [i.yAxis[g.options.yAxis]] : Aa(h, function(a) {
            return a.yAxis
        }) : s(g.options.xAxis) ? [i.xAxis[g.options.xAxis]] : Aa(h, function(a) {
            return a.xAxis
        });
    ...
    na.prototype.crispPolyLine = function(a, b) {
        ...
        for (c = 0; c < a.length; c += 6)
            a[c + 1] === a[c + 4] && (a[c + 1] = a[c + 4] = w(a[c + 1]) - b % 2 / 2), a[c + 2] === a[c +
    ...
    var lc = da.init, mc = da.processData, nc = Ca.prototype.tooltipFormatter;
    da.init = function() {
    ...
    S(P.prototype, "render", function(a) {
        if (this.chart.options._stock)
            !this.clipBox && this.animate && this.animate.toString().indexOf("sharedClip") !== -1 ? (this.clipBox = y(this.chart.clipBox),
                    this.clipBox.width = this.xAxis.len, this.clipBox.height = this.yAxis.len) : this.chart[this.sharedClipKey] && (ab(this.chart[this.sharedClipKey]), this.chart[this.sharedClipKey].attr({width: this.xAxis.len, height: this.yAxis.len}));
        a.call(this)
    });
    x(z, {Color: wa, Point: Ca, Tick: Za, Renderer: Wa, SVGElement: $, SVGRenderer: na, arrayMin: Sa, arrayMax: Fa, charts: ca, dateFormat: ka, error: qa, format: Ma, pathAnim: Ib, getOptions: function() {
            return F
        }, hasBidiBug: Wb, isTouchDevice: fb, setOptions: function(a) {
            F = y(!0, F, a);
            Nb();
            return F
        }, addEvent: D,
