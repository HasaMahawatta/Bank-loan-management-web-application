...
class CHtml
  ...
  public static function submitButton($label = 'submit', $htmlOptions = array())
    ...
    $htmlOptions = self::goBootstrap($htmlOptions, 'class', 'btn btn-info');
  ...
  public static function textField($name, $value = '', $htmlOptions = array())
    ...
    $htmlOptions = self::goBootstrap($htmlOptions, 'class', 'form-control');
...
EOD;
  ...
  public static function goBootstrap($htmlOptions, $needle, $append)
    {
    if (isset($htmlOptions[$needle]))
      {
      $htmlOptions[$needle] = $append . ' ' . $htmlOptions[$needle];
      }
    else
      {
      $htmlOptions[$needle] = $append;
      }
    return $htmlOptions;
    }
