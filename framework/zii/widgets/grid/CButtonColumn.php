...
class CButtonColumn extends CGridColumn
  ...
  protected function initDefaultButtons()
    ...
    $gylphs = array('view' => '<span class="glyphicon glyphicon-align-center"></span>', 'update' => '<span class="glyphicon glyphicon-pencil"></span>', 'delete' => '<span class="glyphicon glyphicon-trash"></span>');
    ...
    foreach (array('view', 'update', 'delete') as $id)
      ...
      $button = array(
        ...
        'options' => array('title' => $this->{$id . 'ButtonLabel'})
      );
